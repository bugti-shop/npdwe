...
export const SketchLayerPanel = ({
  ...
  return (
    <>
      ...
      {/* Layer Sidebar Panel */}
      {isOpen && (
        <div className="fixed right-0 top-0 bottom-0 w-28 bg-background border-l shadow-lg z-50 flex flex-col" style={{ paddingTop: 'env(safe-area-inset-top, 0px)', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
          {/* Add Layer Button */}
          <button
            onClick={onLayerAdd}
