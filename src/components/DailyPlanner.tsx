                      ...
                      {blockTasks.map((task) => (
                        ...
                        >
                          <button
                            ...
                            className="w-5 h-5 rounded border-2 border-muted-foreground/50 hover:border-success hover:bg-success/10 flex items-center justify-center transition-colors"
                          >
                            <CheckCircle2 className="h-3 w-3 text-transparent group-hover:text-success" />
                          </button>
