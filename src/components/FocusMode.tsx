          ...
          <>
            ...
            <div className="flex items-center justify-center gap-6 py-4 border-b border-border/50">
              <div className="text-center">
                <p className="text-2xl font-bold text-success">{completedInSession}</p>
            ...
            <div className="p-6 border-t border-border space-y-4">
              <div className="flex items-center justify-center gap-4">
                ...
                <Button
                  size="lg"
                  className="h-14 px-8 rounded-full bg-success hover:bg-success/90 text-success-foreground"
